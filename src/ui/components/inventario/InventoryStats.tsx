import { Package, CheckCircle, AlertTriangle, DollarSign, ShoppingCart } from "lucide-react";
...
export function InventoryStats({ totalProductos, stockNormal, stockBajo, valorTotal, totalComprasRecientes }: InventoryStatsProps) {
  return (
