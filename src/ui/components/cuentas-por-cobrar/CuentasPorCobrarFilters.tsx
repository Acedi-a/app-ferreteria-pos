// src/components/cuentas-por-cobrar/CuentasPorCobrarFilters.tsx
import { Search, Filter, X } from "lucide-react";
import { Card, CardContent } from "../ui/Card";
import { Button } from "../ui/Button";
import type { FiltrosCuentasPorCobrar } from "../../services/cuentas-por-cobrar-service";

interface CuentasPorCobrarFiltersProps {
  filtros: FiltrosCuentasPorCobrar;
  onCambiarFiltros: (filtros: FiltrosCuentasPorCobrar) => void;
  onLimpiarFiltros: () => void;
}

export default function CuentasPorCobrarFilters({
  filtros,
  onCambiarFiltros,
  onLimpiarFiltros
}: CuentasPorCobrarFiltersProps) {
  
  const handleChange = (campo: keyof FiltrosCuentasPorCobrar, valor: string) => {
    onCambiarFiltros({
      ...filtros,
      [campo]: valor
    });
